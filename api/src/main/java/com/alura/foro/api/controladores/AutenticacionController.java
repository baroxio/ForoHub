package com.alura.foro.api.controladores;
...
import com.alura.foro.api.seguridad.TokenService;
...
public class AutenticacionController {
    ...
    public ResponseEntity autenticarUsuario(@RequestBody @Valid DatosAutenticacionUsuario datosAutenticacion) {
        System.out.println("Function auenticarUsuario");
        ...
        //System.out.println(usuarioAutenticado.getDetails());
